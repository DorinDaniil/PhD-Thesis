...
\begin{figure}[h!]
	\centering
	\subfloat[\centeringАлгоритм]{\includegraphics[width=0.26\textwidth]{figs/Figure_5.png}}\hfill
	\subfloat[\centeringСтатистически значимые области]{\includegraphics[width=0.26\textwidth]{figs/Figure_6.png}}\hfill
	\subfloat[\centeringРазметка нейробиологов]{\includegraphics[width=0.26\textwidth]{figs/Figure_7.png}}
\end{figure}
...
\begin{enumerate}
\justifying
    \item \textit{\textbf{Dorin D}. et al.} Forecasting fMRI Images From Video Sequences: Linear Model Analysis // Health Information Science and Systems.~-- 2024.
